...
{
    public partial class CrunchBaseContext : DbContext
    {
        public CrunchBaseContext()
        {
        }

        public CrunchBaseContext(DbContextOptions<CrunchBaseContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<InvestmentStages> InvestmentStages { get; set; }
        public virtual DbSet<Investor> Investor { get; set; }
        public virtual DbSet<InvestorType> InvestorType { get; set; }
        public virtual DbSet<StockHeld> StockHeld { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=SE130496;Database=CrunchBase;Trusted_Connection=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>(entity =>
            {
                entity.HasIndex(e => e.Username)
                    .HasName("UQ__Account__F3DBC5726F3E4F32")
                    .IsUnique();
                ...
                entity.Property(e => e.ContributorStatus).HasColumnName("contributor_status");
            ...
            modelBuilder.Entity<AspnetApplications>(entity =>
            {
                entity.HasKey(e => e.ApplicationId)
                    .HasName("PK__aspnet_A__C93A4C98082C65E2")
                    .IsClustered(false);

                entity.ToTable("aspnet_Applications");

                entity.HasIndex(e => e.ApplicationName)
                    .HasName("UQ__aspnet_A__30910331FAF494B1")
                    .IsUnique();
            ...
            modelBuilder.Entity<AspnetMembership>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__aspnet_M__1788CC4DBC6603C4")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<AspnetPaths>(entity =>
            {
                entity.HasKey(e => e.PathId)
                    .HasName("PK__aspnet_P__CD67DC5895F1C72E")
                    .IsClustered(false);
            ...
            {
                entity.HasKey(e => e.PathId)
                    .HasName("PK__aspnet_P__CD67DC59C8B361EB");
            ...
            modelBuilder.Entity<AspnetPersonalizationPerUser>(entity =>
            {
                entity.HasKey(e => e.Id)
                    .HasName("PK__aspnet_P__3214EC06EB41F852")
                    .IsClustered(false);
            ...
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__aspnet_P__1788CC4CAEFFB83A");
            ...
            modelBuilder.Entity<AspnetRoles>(entity =>
            {
                entity.HasKey(e => e.RoleId)
                    .HasName("PK__aspnet_R__8AFACE1B8C9C9816")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<AspnetSchemaVersions>(entity =>
            {
                entity.HasKey(e => new { e.Feature, e.CompatibleSchemaVersion })
                    .HasName("PK__aspnet_S__5A1E6BC130A5385B");
            ...
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__aspnet_U__1788CC4D6F5CEB20")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<AspnetUsersInRoles>(entity =>
            {
                entity.HasKey(e => new { e.UserId, e.RoleId })
                    .HasName("PK__aspnet_U__AF2760AD970F5570");
            ...
            modelBuilder.Entity<AspnetWebEventEvents>(entity =>
            {
                entity.HasKey(e => e.EventId)
                    .HasName("PK__aspnet_W__7944C810A61F19E3");
            ...
            modelBuilder.Entity<Company>(entity =>
            {
                ...
                entity.Property(e => e.FoundedDate)
                ...
                entity.Property(e => e.InvestmentStages).HasColumnName("investment_stages");

                entity.Property(e => e.IsApproved).HasColumnName("isApproved");

                entity.Property(e => e.LastFundingTypeId)
                    .HasColumnName("last_funding_type_id")
                    .HasMaxLength(255);
                ...
                entity.Property(e => e.NumberOfEmployes)
                    .HasColumnName("number_of_employes")
                    .HasMaxLength(255);

                entity.Property(e => e.OperatingStatus).HasColumnName("operating_status");

                entity.Property(e => e.Phone)
                    .HasColumnName("phone")
                    .HasMaxLength(255);

                entity.Property(e => e.PostFundingStockValue).HasColumnName("post_funding_stock_value");

                entity.Property(e => e.PreFundingStockValue).HasColumnName("pre_funding_stock_value");

                entity.HasOne(d => d.Creator)
                    .WithMany(p => p.Company)
                    .HasForeignKey(d => d.CreatorId)
                    .HasConstraintName("FK__company__creator__3B75D760");

                entity.HasOne(d => d.InvestmentStagesNavigation)
                    .WithMany(p => p.Company)
                    .HasForeignKey(d => d.InvestmentStages)
                    .HasConstraintName("FK__company__investm__3A81B327");

                entity.HasOne(d => d.Location)
                    .WithMany(p => p.Company)
                    .HasForeignKey(d => d.LocationId)
                    .HasConstraintName("FK__company__locatio__398D8EEE");
            });
            ...
            modelBuilder.Entity<IndustryList>(entity =>
            {
                entity.ToTable("industry_list");
                ...
                entity.HasOne(d => d.Company)
                    .WithMany(p => p.IndustryList)
                    .HasForeignKey(d => d.CompanyId)
                    .HasConstraintName("FK__industry___compa__3C69FB99");

                entity.HasOne(d => d.Industry)
                    .WithMany(p => p.IndustryList)
                    .HasForeignKey(d => d.IndustryId)
                    .HasConstraintName("FK__industry___indus__3D5E1FD2");
            });
            ...
            modelBuilder.Entity<Investment>(entity =>
            {
                ...
                entity.Property(e => e.FundingRoundId).HasColumnName("funding_round_id");

                entity.Property(e => e.InvestedCompanyId).HasColumnName("invested_company_id");

                entity.Property(e => e.InvestorId).HasColumnName("investor_id");

                entity.Property(e => e.LeadInvestor).HasColumnName("lead_investor");

                entity.Property(e => e.MoneyRaised).HasColumnName("money_raised");

                entity.Property(e => e.StockPublised).HasColumnName("stock_publised");

                entity.HasOne(d => d.FundingRound)
                    .WithMany(p => p.Investment)
                    .HasForeignKey(d => d.FundingRoundId)
                    .HasConstraintName("FK__investmen__fundi__4222D4EF");

                entity.HasOne(d => d.InvestedCompany)
                    .WithMany(p => p.Investment)
                    .HasForeignKey(d => d.InvestedCompanyId)
                    .HasConstraintName("FK__investmen__inves__412EB0B6");

                entity.HasOne(d => d.Investor)
                    .WithMany(p => p.Investment)
                    .HasForeignKey(d => d.InvestorId)
                    .HasConstraintName("FK__investmen__inves__403A8C7D");
            });

            modelBuilder.Entity<InvestmentStages>(entity =>
            {
                entity.ToTable("investment_stages");
            ...
            modelBuilder.Entity<Investor>(entity =>
            {
                ...
                entity.Property(e => e.InvestorTypeId).HasColumnName("Investor_type_id");
                ...
                entity.HasOne(d => d.InvestorType)
                    ...
                    .HasConstraintName("FK__investor__Invest__4316F928");
            });
            ...
            modelBuilder.Entity<StockHeld>(entity =>
            {
                entity.ToTable("stock_held");
                ...
                entity.Property(e => e.StockHeld1).HasColumnName("stock_held");

                entity.HasOne(d => d.InvestedCompany)
                    .WithMany(p => p.StockHeld)
                    .HasForeignKey(d => d.InvestedCompanyId)
                    .HasConstraintName("FK__stock_hel__inves__3F466844");

                entity.HasOne(d => d.Investor)
                    .WithMany(p => p.StockHeld)
                    .HasForeignKey(d => d.InvestorId)
                    .HasConstraintName("FK__stock_hel__inves__3E52440B");
            });
